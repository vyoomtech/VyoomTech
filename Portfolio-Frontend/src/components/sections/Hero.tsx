      ...
      <div className="relative mt-12 z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="max-w-6xl mx-auto flex flex-col items-center w-full">
          ...
          >
            <Button
              variant="hero"
              size="default" // Changed from lg to default or a smaller custom size
            ...
            >
              Start Your Project
              <ArrowRight className="ml-2 w-4 h-4" /> {/* Smaller icon */}
            </Button>
            <Button
              variant="outline"
              size="default" // Changed from lg to default or a smaller custom size
            ...
            >
              <Play className="mr-2 w-4 h-4" /> {/* Smaller icon */}
              Watch Demo
            </Button>
          </div>
